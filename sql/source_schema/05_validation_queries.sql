...
PRINT N'6. Facturas de los tres registros del cliente Juan Pérez';
SELECT *
FROM dbo.vw_FacturasConCliente
WHERE IdClienteOrigen IN (1, 2, 3)
ORDER BY IdFacturaOrigen;

PRINT N'7. Últimas ejecuciones de carga';
SELECT TOP (10) *
FROM dbo.CargaOrigenLog
ORDER BY IdCarga DESC;

PRINT N'8. Errores registrados';
SELECT TOP (10) *
